# Welcome to the SR Linux workshop for SSC-ICE
...
---
<div align=center>
<a href="https://codespaces.new/cparmaks/ssc-ice-workshop?quickstart=1">
<img src="https://gitlab.com/rdodin/pics/-/wikis/uploads/d78a6f9f6869b3ac3c286928dd52fa08/run_in_codespaces-v1.svg?sanitize=true" style="width:50%"/></a>

**[Run](https://codespaces.new/cparmaks/ssc-ice-workshop?quickstart=1) this lab in GitHub Codespaces for free**.  
...
```
git clone https://github.com/cparmaks/ssc-ice-workshop.git
```
...
INFO[0000] Parsing & checking topology file: srl-ssc-ice.clab.yml 
INFO[0000] Creating docker network: Name="srl-ssc-ice-lab-mgmt", IPv4Subnet="172.20.20.0/24", IPv6Subnet="2001:172:20:20::/64", MTU=0 
...
INFO[0057] Creating lab directory: /workspaces/ssc-ice-workshop/clab-srl-ssc-ice 
...
```bash
cd config
sudo clab dep -t clab-ssc-ice-full-config.yml
```
